<%@page import="ql.vatlieuxaydung.models.CustomerModel"%>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="projectTable" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <%ArrayList<CustomerModel> cus = (ArrayList<CustomerModel>)request.getAttribute("listcus");
                                                    for (CustomerModel c : cus) {%>
                                                        <tr>
                                                            <th><%=c.getName()%></th>
                                                            <th><%=c.getAddress()%></th>
                                                            <th><%=c.getPhone()%></th>
                                                            ...
                                                            <th>
                                                                <a href="${pageContext.request.contextPath}/editcustomer/?id=<%=c.getID()%>">Edit</a>
                                                            </th>
                                                            <th>
                                                                <a  class="hovermouse" onClick="deleteCustomer(<%=c.getID()%>)">Delete</a>
            ...
            <!-- confirm dialog-->
            <div class="modal fade" id="confirmDeleteCustomer" tabindex="-1" role="dialog" aria-labelledby="modelLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form class="form" id="" action="${pageContext.request.contextPath}/deleteidcustomer" method="POST">
