                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <form class="form" id="" action="${pageContext.request.contextPath}/addproduct" method="POST" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group required">
                                                    <label class="control-label">Import Price</label>
                                                    <div>
                                                        <input id="import_price" name="import_price" type="number"
                                                            class="form-control" maxlength="255" value=""
                                                            placeholder="Product Import Price">
                                                    </div>
                                                </div>    
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div>
                                                     <select id="category_id" name="category_id" class="form-control">
                                                                <option></option>
                                                                <%ArrayList<CategoryModel> cus = (ArrayList<CategoryModel>)request.getAttribute("getnameaddproduct");
