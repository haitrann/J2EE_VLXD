					...
					<div class="row">
						<div class="col-12">
							<div class="card card-primary card-outline">
								...
								<div class="card-body">
									<form class="form" id="" action="./EditCategoryServlet"
										method="POST">
										<%
											CategoryDTO category = (CategoryDTO) request.getAttribute("infoEditCategory");
										%>
										<div class="row">
											<div class="col col-lg-2">
												<div class="input-group mb-3">
													...
													<button type="button" class="btn btn-success">
														Category Id <span class="badge badge-light"><%=category.getId()%></span>
													</button>
												</div>
											</div>
												...
												<div class="form-group required">
													...
													<div>
														<input id="name" name="name" type="text"
															class="form-control" value=" <%=category.getName()%> ">
													</div>
												</div>
											</div>
